...
target "aerospike_tools_amd64" {
	 tags=["aerospike/aerospike-tools-amd64:11.0.1", "aerospike/aerospike-tools-amd64:latest"]
	 platforms=["linux/amd64"]
	 context="."
}

target "aerospike_tools_arm64" {
	 tags=["aerospike/aerospike-tools-arm64:11.0.1", "aerospike/aerospike-tools-arm64:latest"]
...
target "aerospike_tools" {
	 tags=["aerospike/aerospike-tools:11.0.1", "aerospike/aerospike-tools:11.0.1_1", "aerospike/aerospike-tools:latest"]
