...
target "aerospike_tools_amd64" {
	 tags=["aerospike/aerospike-tools-amd64:8.4.0", "aerospike/aerospike-tools-amd64:latest"]
	 platforms=["linux/amd64"]
	 context="."
}

target "aerospike_tools_arm64" {
	 tags=["aerospike/aerospike-tools-arm64:8.4.0", "aerospike/aerospike-tools-arm64:latest"]
...
target "aerospike_tools" {
	 tags=["aerospike/aerospike-tools:8.4.0", "aerospike/aerospike-tools:8.4.0_1", "aerospike/aerospike-tools:latest"]
